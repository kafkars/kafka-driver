...
impl std::fmt::Debug for Reactor {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            ...
            .field("allocated_children", &self.brokers.allocated_children())
            .field("connected_children", &self.brokers.connected_children())
            .field("resolving_children", &self.brokers.resolving_children())
            .field("waiting_calls", &self.brokers.waiting_calls())
