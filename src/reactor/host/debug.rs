...
impl std::fmt::Debug for Reactor {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            ...
            .field("allocated_lanes", &self.brokers.allocated_lanes())
            .field("connected_lanes", &self.brokers.connected_lanes())
            .field("resolving_lanes", &self.brokers.resolving_lanes())
